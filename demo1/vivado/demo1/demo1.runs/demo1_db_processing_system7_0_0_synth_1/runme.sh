...
HD_PWD='C:/Users/dianhsu/Desktop/axi-demo/demo1/vivado/demo1/demo1.runs/demo1_db_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo1_db_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo1_db_processing_system7_0_0.tcl
