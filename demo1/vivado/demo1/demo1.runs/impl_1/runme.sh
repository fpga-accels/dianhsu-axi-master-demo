...
HD_PWD='C:/Users/dianhsu/Desktop/axi-demo/demo1/vivado/demo1/demo1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo1_db_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo1_db_wrapper.tcl -notrace
