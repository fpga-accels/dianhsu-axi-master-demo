...
#
# Generated by export_simulation on Thu Jan 28 18:21:12 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './demo1_db.sh' script.

./demo1_db.sh -reset_run
...
./demo1_db.sh -noclean_files

For more information on the script, please type './demo1_db.sh -help'.
